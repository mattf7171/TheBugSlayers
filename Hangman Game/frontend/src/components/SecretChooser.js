    ...
    <div className="screen">
      <div className="card">
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
          <div>
            <h2 className="card-title">Secret Phrase</h2>
            <p className="card-subtitle">
              Enter a custom phrase, or let the system draw a random one from the
              database. Your partner will only see blanks.
            </p>
          </div>
          <span className="badge">You are the Setter</span>
        </div>
